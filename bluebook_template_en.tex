...
\begin{figure}[htbp]
  \centering
  \IfFileExists{figures/FigJoin.png}{\includegraphics[width=0.92\textwidth]{figures/FigJoin.png}}{%
    \fbox{\parbox{0.92\textwidth}{\vspace{18mm}\centering\textbf{Figure: Evidence-join dependency graph (placeholder: figures/FigJoin.png)}\par\vspace{4mm}\footnotesize Gateway $\rightarrow$ Retrieval $\rightarrow$ Kernel $\rightarrow$ Tool layers threaded by \texttt{correlation\_id}, producing joinable rows for the Release Evidence Pack.\par\vspace{18mm}}}%
  }
...
\begin{figure}[htbp]
  ...
  \IfFileExists{figures/Fig3.1.png}{\includegraphics[width=0.92\textwidth]{figures/Fig3.1.png}}{%
    \fbox{\parbox{0.92\textwidth}{\vspace{22mm}\centering\textbf{Figure 3.1 placeholder: figures/Fig3.1.png}\par\vspace{22mm}}}%
  }
