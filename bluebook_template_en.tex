...
\begin{figure}[htbp]
  ...
  \caption{Responsibility-boundary topology of the Unified AI Security Control Plane (visual anchor for Section ``System boundary and responsibility split'')}
...
\section{Benchmark Constitution: measurement obligations as coverage law}
...
\noindent\textbf{Implementation note.} Teams may picture ``source \(\rightarrow\) build \(\rightarrow\) ship'' for onboarding; Chapter~5 remains authoritative for admissibility and contract shape.
