...
\begin{itemize}
  \item \textbf{E1--E3（Fail-Safe 协议）}——代表性对抗与社会技术场景下，触发—降级—返回路径的正确性；降级路径 p95/p99 时延与成功返回率；恢复必要性（何种条件必须进入 Tier-R2）。
...
\begin{itemize}
  ...
  \item \textbf{治理前提}——Tier-R2 审批链、法务与数据主体权利流程可用；若不可用，则禁止依赖人工恢复的全能力路径。
